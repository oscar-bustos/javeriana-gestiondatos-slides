...
::: {.callout-tip title="Dinámica por Parejas (5 min)"}
Entrevista a tu compañero/a y presenta al grupo:

- **Nombre** y profesión / pregrado de origen.
- **Empresa** y cargo / área de desempeño actual.
- **Proyecto o reto de datos** en su organización.
- **Expectativa principal** sobre esta asignatura.
:::
...
::: {layout-ncol=3}
![Hands-On Data Preprocessing in Python](assets/HandsOnDataProcessing.png){height=300px}
...
::: {.r-stretch}
![Cronograma Gestión de Datos](assets/CronogramaGestion.png){fig-align="center"}
:::
