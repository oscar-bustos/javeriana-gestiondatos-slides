...
- **Clase amigable con la IA**:

  - Se promueve el uso de IA para generación de código Python.

  - El objetivo principal es enfocarse en el **análisis** de datos.
...
Usamos **Pandas** para cargar y manipular los datos iniciales del Titanic.
...
## 1. Distribución de Datos (Data Distribution)
...
## 5. Patrones y Tendencias (Patterns & Trends)
...
- **Herramientas**: Gráficos de línea, promedios móviles, agrupaciones secuenciales.
:::
::::
...
## 7. Visualización de Datos (Data Visualization)
...
## 8. Estadísticas Descriptivas (Summary Statistics)
...
## 9. Control de Calidad de Datos (Data Quality)
...
## 10. Relación de Características (Feature Relationships)
...
2. **Visión general**: Conocer tamaño (shape) y tipos de datos.

3. **Limpieza inicial**: Tratar faltantes, duplicados y atípicos.

4. **Análisis Univariado**: Explorar cada variable por separado.

5. **Análisis Bivariado**: Explorar relaciones cruzadas.

6. **Reporte / Documentación**: Extraer insights y siguientes pasos.
