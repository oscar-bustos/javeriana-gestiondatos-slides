...
![Resumen de Técnicas de Normalización](assets/normalizations-at-a-glance-v2.svg){width="65%"}
...
![](assets/MinMax.png){width="50%"}  \caption{Min Max\footnotemark}
\end{figure}
...
![Z score](assets/norm-z-score.svg){width="55%"}
...
## Normalización Estadística o Z-Score {.smaller}
...
![Log normalization](assets/norm-log-scaling-movie-ratings.svg){width="55%"}
...
## Ejemplo de Código Python para Z Score {.smaller}
...
## Ejemplo de Código Python para Min Max {.smaller}
